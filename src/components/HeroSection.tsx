    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            {/* Typing Animation */}
            <h1 className="text-6xl md:text-8xl lg:text-9xl font-bold mb-6 neon-glow">
              {text}
            ...
            <motion.div
              ...
              className="relative"
            >
              <p className="text-2xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-400 bg-clip-text text-transparent animate-gradient">
            ...
            <motion.p
              ...
              className="text-xl md:text-2xl text-blue-300/80 mb-12 font-light tracking-wide"
            >
